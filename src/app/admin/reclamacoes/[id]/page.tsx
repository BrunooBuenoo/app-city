  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
      <div className="w-20 h-20 rounded-3xl bg-[#E8F2F8] flex items-center justify-center mb-6">
        <span className="material-symbols-outlined text-[#1a8ccc] text-[40px]">description</span>
      </div>
      <h2 className="text-2xl font-semibold text-[#112F4E] mb-2">Detalhe da Reclamação</h2>
      <p className="text-[#4A5D70] text-base font-light max-w-md">
        A visualização detalhada estará disponível em breve.
      </p>
