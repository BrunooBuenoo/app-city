...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "mock-auth-domain-for-build-time-pass.firebaseapp.com",
...
// Evita inicializar múltiplas vezes (HMR do Next.js)
